        ...
        <div className="max-w-md mx-auto">
            ...
            <div className="flex bg-gray-100 p-1 rounded-lg mb-6">
                <button
                    ...
                    className={`flex-1 py-2 text-sm font-semibold rounded-md transition-all ${mode === 'register' ? 'bg-white text-transparent bg-clip-text bg-gradient-to-r from-brand to-brand-dark shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
                >
                    Criar Conta
                </button>
                <button
                    onClick={() => setMode('login')}
                    className={`flex-1 py-2 text-sm font-semibold rounded-md transition-all ${mode === 'login' ? 'bg-white text-transparent bg-clip-text bg-gradient-to-r from-brand to-brand-dark shadow-sm' : 'text-gray-500 hover:text-gray-700'}`}
                >
                    Já tenho conta
                </button>
            </div>
