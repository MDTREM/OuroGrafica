...
export function AdminMobileTopBar() {
    return (
        <div className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-100 lg:hidden px-4 h-16 flex items-center justify-between shadow-sm">
            ...
            <Link
                href="/"
                className="text-xs font-bold text-transparent bg-clip-text bg-gradient-to-r from-brand to-brand-dark flex items-center gap-2 hover:bg-gradient-to-r from-brand to-brand-dark/5 px-3 py-1.5 rounded-full transition-colors border border-brand/20"
            >
                <Store size={14} />
                Ver Loja
            </Link>
