                ...
                <div className="max-w-2xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                    <div className="p-8">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <h2 className="text-xl font-semibold text-gray-900">Solicitar Proposta</h2>
                        </div>
                        ...
                        {formStatus === 'sent' ? (
                            <div className="text-center py-12 space-y-6">
                                ...
                                <div>
                                    <h3 className="text-2xl font-semibold text-gray-800">Proposta Solicitada!</h3>
                                    <p className="text-gray-600 mt-2">Nossa equipe entrará em contato em breve.</p>
                                </div>
                                <button onClick={() => setFormStatus('idle')} className="text-transparent bg-clip-text bg-gradient-to-r from-brand to-brand-dark font-medium hover:underline">Enviar nova solicitação</button>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <button
                                    ...
                                    className="w-full bg-[#FF6B07] text-white font-semibold h-12 rounded-xl hover:bg-[#e65a00] transition-all flex items-center justify-center gap-2 disabled:opacity-70 shadow-lg shadow-orange-200 active:scale-[0.98]"
                                >
                                    {formStatus === 'sending' ? (
                                        <>Enviando...</>
                                    ) : (
                        ...
                        <a
                            href="https://wa.me/5531989880161?text=Olá! Tenho interesse no serviço de Outsourcing."
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-full bg-[#FF6B07] text-white font-semibold h-12 rounded-xl hover:bg-[#e65a00] transition-all flex items-center justify-center gap-2 shadow-lg shadow-orange-200 active:scale-[0.98]"
                        >
