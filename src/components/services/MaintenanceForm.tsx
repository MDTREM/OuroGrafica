...
import { submitMaintenanceRequest } from "@/actions/maintenance-actions";
        ...
        <div id="formulario" className="max-w-lg mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            <div className="p-8">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xl font-semibold text-gray-900">Pré-Orçamento Online</h2>
                </div>
                ...
                {formStatus === 'sent' ? (
                    <div className="text-center py-12">
                        ...
                        <button onClick={() => setFormStatus('idle')} className="text-[#FF6B07] text-sm font-semibold hover:underline">
                            Enviar novo pedido
                        </button>
                    </div>
                ) : (
                ...
                <a
                    href="https://wa.me/5531989880161?text=Olá! Preciso de um orçamento para minha impressora."
                    target="_blank"
