...
export function LocationMap() {
    ...
    return (
        <section className="py-8 pb-12">
            <Container>
                <div className="relative w-full h-[200px] md:h-[400px] rounded-xl overflow-hidden shadow-sm border border-gray-200 group">
                    {/* Map Background */}
                    <iframe
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                        <a
                            ...
                            className="pointer-events-auto bg-white text-[#1a1a1a] font-semibold text-sm md:text-lg py-3 px-6 md:py-4 md:px-8 rounded-xl shadow-2xl flex items-center gap-2 md:gap-3 hover:scale-105 transition-transform duration-300 border border-gray-100"
                        >
