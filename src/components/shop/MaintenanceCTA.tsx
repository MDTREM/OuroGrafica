                ...
                <div className="bg-[#1a1a1a] rounded-[2rem] p-8 relative overflow-hidden shadow-xl group text-left">
                    ...
                    <div className="relative z-10 flex flex-col items-start gap-2 max-w-2xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 w-full">
                            <a
                                href="https://wa.me/5531989880161?text=Ol%C3%A1%2C%20minha%20impressora%20est%C3%A1%20com%20problema%20e%20preciso%20de%20ajuda%20urgente!"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex-1 inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-semibold py-3.5 px-4 rounded-xl hover:bg-[#20bd5a] transition-all shadow-lg hover:shadow-xl active:scale-[0.98] text-sm md:text-base whitespace-nowrap"
                            >
                            ...
                            <Link
                                ...
                                className="flex-1 inline-flex items-center justify-center gap-2 bg-[#ff6b07] text-white font-semibold py-3.5 px-4 rounded-xl hover:bg-[#e65a00] transition-all shadow-lg hover:shadow-xl active:scale-[0.98] text-sm md:text-base whitespace-nowrap"
                            >
                                <Printer size={18} />
                                Orçamento Online
                            </Link>
