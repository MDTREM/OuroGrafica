    ...
    return (
        <div className="bg-gray-50 min-h-screen pb-20">
            ...
            <div className="bg-white border-b border-gray-100 pt-8 pb-6 mb-6">
                <Container>
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900 mb-1">Olá, {user.name}</h1>
            ...
            <Container>
                ...
                {/* Quit Button */}
                <button className="w-full md:w-auto flex items-center justify-center gap-2 text-red-600 font-bold bg-white border border-red-100 hover:bg-red-50 px-6 py-3 rounded-xl transition-colors mx-auto md:mx-0">
                    <LogOut size={18} />
                    Sair da Conta
                </button>
            </Container>
