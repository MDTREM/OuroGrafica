...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative">
            {/* Back Button */}
            <Link href="/" className="absolute top-6 left-6 p-2 text-gray-500 hover:text-brand transition-colors bg-white rounded-full shadow-sm border border-gray-100">
                <ArrowLeft size={20} />
            </Link>
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-2 text-center text-sm text-gray-600">
                    Não tem uma conta?{" "}
                    <Link href="/cadastro" className="font-bold text-brand hover:text-brand-dark transition-colors">
                        Cadastre-se grátis
                    </Link>
                </p>
            </div>
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-8 text-center text-xs text-gray-500">
                    &copy; {new Date().getFullYear()} Ouro Gráfica. Todos os direitos reservados.
                </p>
            </div>
        </div>
    );
