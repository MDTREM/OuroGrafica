          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="animate-element animate-delay-600 w-full rounded-2xl bg-brand text-white py-4 font-semibold hover:bg-brand-dark hover:scale-[1.01] active:scale-[0.99] shadow-lg shadow-brand/10 transition-all disabled:opacity-75 disabled:cursor-not-allowed"
              >
